...
| `UPDATE_GITHUB_TOKEN` | No | *(empty)* | Token for `api.github.com` release or custom-image workflow checks only; private forks need Actions read access, while asset downloads remain anonymous. |

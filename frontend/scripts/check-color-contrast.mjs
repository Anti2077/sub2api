...
const checks = [
  ...
  ['group-actions.edit-hover.dark', 'primary100', 'dark700'],
  ['group-actions.composite-routes-hover.light', 'cyan700', 'gray100'],
  ['group-actions.composite-routes-hover.dark', 'cyan100', 'dark700'],
  ['group-actions.rate-multiplier-hover.light', 'purple700', 'gray100'],
  ['group-actions.rate-multiplier-hover.dark', 'purple100', 'dark700'],
  ['group-actions.rpm-override-hover.light', 'orange700', 'gray100'],
  ['group-actions.rpm-override-hover.dark', 'orange100', 'dark700'],
  ...
  ['badge.primary.dark', 'primary100', blend(colors.primary900, colors.dark800, 0.3)],
  ['badge.success.dark', 'emerald100', blend(colors.emerald900, colors.dark800, 0.3)],
  ['badge.warning.dark', 'amber100', blend(colors.amber900, colors.dark800, 0.3)],
  ['badge.danger.dark', 'red100', blend(colors.red900, colors.dark800, 0.3)],

 ...
 * @param type - Optional type filter (balance, affiliate_balance, promo_balance, lottery_balance, invitation, admin_balance, concurrency, admin_concurrency, subscription)

export default {
  dashboard: {
    ...
    usageEquivalence: {
      ...
      activity: 'Activity',
      activityValue: '{requests} requests · {tokens} tokens',
  ...
  redeem: {
    ...
    balanceAddedPromo: 'Balance Added (Signup Promo)',
    balanceAddedLottery: 'Balance Added (Daily Lottery)',
    balanceAddedAdmin: 'Balance Added (Admin)',
    balanceDeductedAdmin: 'Balance Deducted (Admin)',
    invitationUsed: 'Signup Invitation Used',
    invitationUsedValue: 'Used',
  ...
  profile: {
    ...
    confirmUsernameTitle: 'Confirm username',
    confirmUsernameDescription: 'Confirm a unique username before entering the dashboard. Third-party profile names are suggestions only.',
    confirmUsernameHint: 'Up to 100 characters. Control characters are not allowed.',
    confirmUsernameAction: 'Confirm and continue',
    leaderboardAnonymous: 'Anonymous on leaderboard',
    leaderboardAnonymousHint: 'Show as Anonymous User in the leaderboard',

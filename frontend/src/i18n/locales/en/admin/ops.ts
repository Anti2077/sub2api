export default {
    ops: {
      ...
      routingMonitor: {
        ...
        description: 'Track live traffic from users and requested models to the actual account or upstream. Includes active requests and completions or failures from the last minute.',
        refresh: 'Refresh',
        ...
        empty: 'No routing events in the last minute.',
        ...
        filters: { user: 'User', requestedModel: 'Requested model', account: 'Account', all: 'All' },
        status: { connecting: 'Connecting', connected: 'Connected', polling: 'Snapshot sync', reconnecting: 'Reconnecting', offline: 'Offline', closed: 'Disconnected' },

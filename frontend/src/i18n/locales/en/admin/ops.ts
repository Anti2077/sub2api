export default {
    ops: {
      ...
      routingMonitor: {
        ...
        pausedHint: "The view is paused. Events are still received in the background; resume to see current data.",
        noMatches: "No routes match these filters.",
        clearFilters: "Clear filters",
        graphTitle: "Request flow",
        graphHint: "Select a node or connection to filter routes. Select a route below for requests and account switches.",
        graphLimit: "Graph route limit",
        shownRoutes: "Showing {shown} of {total} routes in the graph",
        edgeHint: "Numbers count requests; dashed connections include active requests. The right column is the final selected account.",
        routeList: "Routes",
        clearSelection: "Clear selection",
        attempts: "Account selections",
        backToOverview: "Ops overview",
        states: {"active": "Active", "completed": "Completed", "failed": "Failed"},
        metrics: {"requests": "Requests in window", "active": "Active", "completed": "Completed", "failed": "Failed"},
        tab: 'Routing Monitor',
        title: 'Realtime Routing Monitor',
        description: 'Track live traffic from users and requested models to the actual account or upstream. Includes active requests and completions or failures from the last 30 seconds.',
        refresh: 'Refresh',
        disabled: 'Realtime monitoring is disabled in settings.',
        loadFailed: 'Failed to load routing monitor',
        waiting: 'Waiting for routing events…',
        empty: 'No routing events in the last 30 seconds.',
        graphLabel: 'Routing graph from users to requested models to actual accounts',
        routeCount: '{count} routes',
        viewAll: 'View all',
        top10: 'Show Top 10',
        details: 'Route details',
        close: 'Close details',
        columns: { user: 'User', requestedModel: 'Requested model', account: 'Actual account / upstream' },
        filters: { platform: 'Platform', user: 'User', requestedModel: 'Requested model', account: 'Account', all: 'All' },
        status: { connecting: 'Connecting', connected: 'Connected', reconnecting: 'Reconnecting', offline: 'Offline', closed: 'Disconnected' },
        detail: { status: 'Status', duration: 'Duration', time: 'Time', requestId: 'Request ID', requestedModel: 'Requested model', upstreamModel: 'Upstream model', hops: 'Account hops', requestList: 'Requests on this route' }
      },

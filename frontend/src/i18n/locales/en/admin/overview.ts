export default {
    ...
    users: {
      ...
      platformOther: 'Other',
      balanceHistoryTitle: 'User Recharge & Entitlement History',
      noBalanceHistory: 'No records found for this user',
      allTypes: 'All Types',
      typeBalance: 'Balance (Redeem)',
      typeAffiliateBalance: 'Balance (Affiliate Transfer)',
      typePromoBalance: 'Balance (Signup Promo)',
      typeLotteryBalance: 'Balance (Daily Lottery)',
      typeInvitation: 'Signup Invitation',

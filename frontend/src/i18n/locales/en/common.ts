export default {
  ...
  leaderboard: {
    ...
    tokenMode: 'Token ranking',
    spendingMode: 'Spending ranking',
    spendingSubtitle: 'Top 20 users by actual spend, shown by username or anonymously',
    day: 'Daily',
    week: 'Weekly',
    month: 'Monthly',
    year: 'Yearly',
  ...
  incentives: {
    ...
    "disabled": "Not active",
    "enabled": "Enabled",
    "next": "Until the next milestone",
    "available": "Available draws",
    "earned": "Earned chances",
    "used": "Used",
    "loading": "Loading…",
    "refresh": "Refresh",
    ...
    "checkInTitle": "Daily check-in draw",
    "checkInDescription": "Check in once a day to earn one draw chance. Check-in and usage chances share the same draw entry.",
    "checkIn": "Check in today",
    "checkingIn": "Checking in…",
    "checkedInToday": "Checked in today",
    "checkInDisabled": "Check-in is not active",
    "consumptionDisabled": "The usage draw is currently inactive, but daily check-in can still grant a draw chance.",
    ...
    "selectGroups": "Select participating groups",
    "searchGroups": "Search group name or ID",
    "noGroups": "No groups found",
    "selectUsers": "Select excluded users",
    "searchUsers": "Search username, email, or ID",
    "noUsers": "No users found",
    "selectModels": "Select excluded models",
    "searchModels": "Search model name",
    "noModels": "No models found",
    "removeOption": "Remove option",
    "idsHint": "Comma-separated IDs. At least one group is required to enable an activity.",
    "threshold": "Spend per milestone ($)",
    "decrease": "Rate reduction per milestone",
    "floor": "Minimum group rate",
    "cap": "Maximum weekly chances (0 = unlimited)",
    "excludeAdmins": "Exclude administrators",
    ...
    "baseRate": "Base rate",
    "save": "Save this activity",
    "saved": "Activity saved",
    "current": "Current periods",
    "reset": "Reset this period",
    "resetConfirm": "Reset this activity now? Current progress and unused chances will expire. History will be preserved."
},
  dailyLottery: {
    title: 'Daily Check-in Draw',
    description: 'Check in each day to receive one draw chance',
    heading: "Today's Check-in",
    subtitle: 'Check in, then draw once for a configured prize',
    disabledTitle: 'The event is not open yet',
    disabledDescription: 'You can check in and draw here after an administrator enables the event.',
    loading: "Loading today's status…",
    loadFailed: 'Unable to load the draw status',
    retry: 'Try Again',
    today: 'Today',
    checkedIn: 'Checked in',
    notCheckedIn: 'Check-in pending',
    chanceAvailable: 'Draw chance available',
    chanceUsed: "Today's chance has been used",
    checkIn: 'Check In',
    checkingIn: 'Checking in…',
    checkInSuccess: 'Checked in. Your draw chance is ready.',
    checkInFailed: 'Check-in failed. Please try again.',
    draw: 'Draw Now',
    drawing: 'Drawing…',
    drawFailed: 'Draw failed. Please try again.',
    resultTitle: "Today's Result",
    won: 'You received “{prize}”',
    rewardAdded: '{amount} was added to your balance',
    noBalanceReward: 'No balance reward this time',
    newBalance: 'Current balance: {amount}',
    prizesTitle: "Today's Prizes",
    probability: '{value} chance',
    resetAt: 'Next chance: {time}',
    serverTimezone: 'Calculated in server timezone {timezone}',
    ...
    pendingDraw: 'Checked in, waiting for draw',
    admin: {
      title: 'Daily Draw Settings',
      description: 'Configure the check-in draw, prize levels, and weights',
      configTitle: 'Event Configuration',
      configSubtitle: 'When enabled, each user can check in for one draw chance per day.',
      enabled: 'Enable daily check-in draw',
      enabledHint: 'Turning it off blocks check-ins and draws while preserving existing history.',
      prizesTitle: 'Prize Levels',
      prizesHint: 'Configure 2–8 levels. A zero reward can represent a no-win result.',
      prizeName: 'Prize Name',
      ...
      moveUp: 'Move up',
      moveDown: 'Move down',
      totalWeight: 'Enabled prize weight: {value}',
      save: 'Save Configuration',
      saving: 'Saving…',
      saved: 'Daily draw configuration saved',
      saveFailed: 'Failed to save the configuration',
      loadFailed: 'Unable to load the daily draw configuration',
      validationPrizeCount: 'Configure between 2 and 8 prize levels',
      validationName: 'Every prize needs a name between 1 and 40 characters',
      validationReward: 'Reward amounts must be between 0 and 1,000,000',
      validationWeight: 'Weights must be integers between 1 and 1,000,000,000',
      validationEnabled: 'Enable at least one prize',
      validationTotalWeight: 'The enabled prize weight cannot exceed 1,000,000,000',
      historyTitle: 'Recent Check-ins and Draws',
      user: 'User',
      checkedInAt: 'Checked In',
      drawnAt: 'Drawn At',
      notDrawn: 'Not drawn',
      historyLoadFailed: 'Unable to load draw history'
    }
  },
  ...
  nav: {
    ...
    dailyLotterySettings: 'Draw Settings',
    settings: 'Settings',
  ...
  wiki: {
    title: 'User Guide',
    eyebrow: 'Sub2API Wiki',
    heading: 'Configure, verify, and troubleshoot',
    subtitle: 'Follow reproducible steps from your first request through client setup, then isolate failures quickly.',
    primaryNavigation: 'Documentation navigation',
    backHome: 'Back to home',
    dashboard: 'Dashboard',
    login: 'Sign in',
    searchLabel: 'Search documentation',
    searchPlaceholder: 'Search CC Switch, API Key, 401…',
    searchAction: 'Search',
    searchResults: 'Search results',
    resultCount: '{count} articles',
    noResults: 'No matching documentation',
    noResultsHint: 'Try a client name, status code, or shorter search term.',
    ...
    articleNotFoundHint: 'The link may have changed, or this article has not been published.',
  },

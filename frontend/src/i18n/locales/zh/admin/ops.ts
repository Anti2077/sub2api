export default {
    ops: {
      ...
      routingMonitor: {
        ...
        tab: '路由监控',
        title: '实时路由监控',
        description: '查看用户、请求模型与实际账号/上游之间的实时流量去向。窗口覆盖进行中请求及最近 30 秒内已完成或失败的请求。',
        refresh: '刷新',
        ...
        filters: { platform: '平台', user: '用户', requestedModel: '请求模型', account: '账号', all: '全部' },
        status: { connecting: '连接中', connected: '已连接', reconnecting: '重连中', offline: '离线', closed: '已断开' },

export default {
    ops: {
      ...
      routingMonitor: {
        ...
        resume: "恢复实时",
        refreshing: "刷新中…",
        pausedHint: "画面已暂停，后台继续接收事件。恢复后显示当前实时数据。",
        noMatches: "没有符合筛选条件的路由。",
        clearFilters: "清除筛选",
        graphTitle: "请求流向",
        graphHint: "点击节点或连线筛选链路；点击下方链路查看请求与账号切换详情。",
        graphLimit: "图中链路上限",
        shownRoutes: "图中显示 {shown} / {total} 条链路",
        edgeHint: "数字表示请求数；虚线表示包含进行中的请求；右侧是最终选中的账号。",
        routeList: "路由链路",
        clearSelection: "取消选中",
        attempts: "账号选择次数",
        backToOverview: "运维概览",
        states: {"active": "进行中", "completed": "已完成", "failed": "失败"},
        metrics: {"requests": "窗口内请求", "active": "进行中", "completed": "已完成", "failed": "失败"},
        tab: '路由监控',
        title: '实时路由监控',
        description: '查看用户、请求模型与实际账号/上游之间的实时流量去向。窗口覆盖进行中请求及最近 1 分钟内已完成或失败的请求。',
        refresh: '刷新',
        disabled: '实时监控已在设置中关闭。',
        loadFailed: '加载路由监控失败',
        waiting: '正在等待路由事件…',
        empty: '最近 1 分钟暂无路由事件。',
        graphLabel: '用户到请求模型再到实际账号的路由图',
        routeCount: '链路 {count}',
        viewAll: '查看全部',
        top10: '仅看 Top 10',
        details: '路由详情',
        close: '关闭详情',
        columns: { user: '用户', requestedModel: '请求模型', account: '实际账号 / 上游' },
        filters: { user: '用户', requestedModel: '请求模型', account: '账号', all: '全部' },
        status: { connecting: '连接中', connected: '已连接', polling: '快照同步', reconnecting: '重连中', offline: '离线', closed: '已断开' },
        detail: { status: '状态', duration: '耗时', time: '时间', requestId: '请求 ID', requestedModel: '请求模型', upstreamModel: '上游模型', hops: '账号跳转', requestList: '此链路请求列表' }
      },

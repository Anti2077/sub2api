export default {
  dashboard: {
    ...
    usageEquivalence: {
      title: 'OpenAI 订阅当量',
      subtitle: '把选定时间的 API 标准价值换算成各计划的 7 天和 30 天额度窗口。',
      ...
      sevenDayWindow: '7 天额度',
      thirtyDayWindow: '30 天额度',
      quotaWindows: '个窗口',
      configuredReference: '配置基准 {value}',
      ...
      retry: '重试',
      officialSource: 'OpenAI 计划说明',
      disclaimer: '按每次请求已记录的标准 API 成本汇总；加权倍率 = 实际余额扣费 ÷ 标准成本，因此会保留历史倍率波动。Plus 的 7 天和 30 天基准由管理员配置，Pro 按 OpenAI 公布的 5x/20x 倍数推算；这是估算，不是官方固定配额承诺。'
    }
  },
  ...
  redeem: {
    ...
    balanceAddedPromo: '余额赠送（注册优惠码）',
    balanceAddedLottery: '余额奖励（每日抽奖）',
    balanceAddedAdmin: '余额充值（管理员）',
    balanceDeductedAdmin: '余额扣除（管理员）',
    invitationUsed: '注册邀请码已使用',
    invitationUsedValue: '已使用',
  ...
  profile: {
    ...
    confirmUsernameTitle: '确认用户名',
    confirmUsernameDescription: '进入后台前，请确认一个唯一用户名。第三方资料仅作为建议，不会自动确认。',
    confirmUsernameHint: '最多 100 个字符，不能包含控制字符。',
    confirmUsernameAction: '确认并继续',
    leaderboardAnonymous: '排行榜匿名',
    leaderboardAnonymousHint: '开启后排行榜显示为匿名用户',
    changePassword: '修改密码',
